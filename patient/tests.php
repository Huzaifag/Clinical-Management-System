                      ...
                      <table class="table table-hover">
                          <thead class="bg-info text-light">
                              <tr>
                                  ...
                                  <th>Probe/Frequency Used</th>
                                  <th>Reason for Examination</th>
                                  <th width='15%'>Check By</th>
                                  <th width='10%'>Vist date</th>
                                  <th width='10%'>Action</th>
                              </tr>
                          </thead>
                          <tbody>
                              <?php
                              $report_q = "SELECT * FROM `test_report` WHERE `patient_id` = ? ORDER BY `date` DESC";
                                  ...
                                  while ($row = mysqli_fetch_assoc($report_res)) {
                                    ...
                                    $doc_name =$docData['name'];
                                      ...
                                      <tr>
                                          ...
                                          <td>' . $row['date'] . '</td>
                                          <td>
                                           <a href="test_detail.php?report_id='.$row['id'].'" class="btn btn-success btn-sm"><i class="bi bi-printer-fill"></i> Print</a>
                                          </td>
                                      </tr>';
