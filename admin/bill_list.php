    ...
    <div class="row">
      <div class="col-lg-10 ms-auto p-4">
        <div class="container-fluid">
          <div class="row">
            <h4 class="alert-heading">Customer Bills</h4>
            <p class="mb-0">View and manage customer bills here.</p>
            <div class="alert alert-success mt-3 shadow-sm" role="alert">
              <a class="btn btn-primary mt-2" href="getPatientFor_bill_list.php">
                <i class="bi bi-file-text"></i> New Bill
              </a>
